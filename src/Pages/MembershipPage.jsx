              ...
              {!isValidated ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-12 animate-in zoom-in-95 duration-500">
                  ...
                  <div className="flex flex-col md:flex-row gap-4 pt-6">
                    <button type="button" className="flex-1 bg-slate-50 text-slate-500 py-5 font-black uppercase text-xs tracking-[0.3em] hover:bg-slate-100 transition-all flex items-center justify-center gap-2">
